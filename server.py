...
WARRANT_AI_TYPE_ALIASES = {
    ...
    'administrative': 'Administrative Warrant',
    'admin': 'Administrative Warrant',
    'administrative warrant': 'Administrative Warrant',
    'extradition': 'Extradition Warrant',
    'extradition warrant': 'Extradition Warrant',
    'fugitive': 'Fugitive Warrant',
    'fugitive warrant': 'Fugitive Warrant',
    'alias': 'Alias Warrant',
    'alias warrant': 'Alias Warrant',
}

WARRANT_AI_STATUS_ALIASES = {
    'active': 'Active',
    'open': 'Active',
    'pending': 'Active',
    'suspended': 'Suspended',
...
def _normalize_warrant_ai_type(value, fallback='Arrest Warrant'):
    ...
    if raw_value in WARRANT_AI_TYPE_OPTIONS:
        return raw_value
    return WARRANT_AI_TYPE_ALIASES.get(raw_value.lower(), fallback_value)


def _normalize_warrant_ai_status(value, fallback='Active'):
    raw_value = _clean_warrant_ai_text(value)
    fallback_value = fallback if fallback in WARRANT_AI_STATUS_OPTIONS else 'Active'
    if raw_value in WARRANT_AI_STATUS_OPTIONS:
        return raw_value
